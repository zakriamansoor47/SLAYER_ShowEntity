...
public partial class SLAYER_ShowEntity : BasePlugin
{
    ...
    public unsafe Vector TraceShape(Vector _origin, QAngle _viewangles, bool fromPlayer = false, bool drawResult = false, float laserlife = 1f)
    {
        ...
        return TraceShape(_origin, _endOrigin, drawResult, laserlife);
    }

    public unsafe Vector TraceShape(Vector? _origin, Vector _endOrigin, bool drawResult = false, float laserlife = 1)
    {
		try
        {
